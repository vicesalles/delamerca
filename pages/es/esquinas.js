...
function Esquinas() {
    ...
    return (<Pagina>
        ...
        <section className="container section content">
            <p className="para"> Esquinas es un juego casual pero intenso de supervivencia callejera. Fuera de Netflix, la industria de la droga no tiene nada de romántico. ¿Cuanto te crees que durarías como peón?
            </p>
